...
export default function AIConference({ playSound }) {
  ...
  const speakers = [
    { initials: 'RK', name: 'Dr. Rajnish Khanna', org: 'Stanford / i-Cultiver', color: '#5478FF', gradient: 'linear-gradient(135deg, #5478FF 0%, #5478FF 100%)', photo: 'https://randomuser.me/api/portraits/men/32.jpg', bio: 'Leading pioneer in applying neural modeling to analyze photosynthesis pathways and plant development networks under extreme biological stress.' },
    { initials: 'JS', name: 'Dr. Jeremy Sweet', org: 'Environmental Advisor, UK', color: '#5478FF', gradient: 'linear-gradient(135deg, #5478FF 0%, #5478FF 100%)', photo: 'https://randomuser.me/api/portraits/men/52.jpg', bio: 'Specialist in algorithmic biosafety and crop forecasting, advising international boards on ecological impact models.' },
    { initials: 'CP', name: 'Prof. Costantino Paciolla', org: 'University of Bari, Italy', color: '#5478FF', gradient: 'linear-gradient(135deg, #5478FF 0%, #5478FF 100%)', photo: 'https://randomuser.me/api/portraits/men/75.jpg', bio: 'Expert biochemist utilizing deep neural networks to diagnostic cellular defense mechanisms in Mediterranean crops.' },
    { initials: 'JZ', name: 'Dr. Jorge A. Zavala', org: 'University of Buenos Aires', color: '#5478FF', gradient: 'linear-gradient(135deg, #5478FF 0%, #5478FF 100%)', photo: 'https://randomuser.me/api/portraits/men/41.jpg', bio: 'Pioneering study in insect-plant defense predictions and environmental adaptations driven by generative machine learning algorithms.' },
  ];
  ...
  const committee = [
    { initials: 'MB', name: 'Dr. M. Ben Massoud', org: 'Dublin University, Ireland', color: '#5478FF' },
    { initials: 'SL', name: 'Dr. Sarah L.', org: 'Cambridge Biotech Institute', color: '#5478FF' },
    { initials: 'HG', name: 'Prof. Hans G.', org: 'Technical University Munich', color: '#5478FF' },
    { initials: 'AM', name: 'Dr. Akira M.', org: 'Kyoto Agri-Systems Lab', color: '#5478FF' },
  ];

  const testimonials = [
    { initials: 'VJ', name: 'Victor Janin', handle: '@victor_janin', color: '#5478FF', quote: 'If you are into deep learning, GCAI is the site you need to follow. Their panels, models, and conferences have been invaluable. Accompanying tools and speakers are 10/10.' },
    { initials: 'DP', name: 'Dimitra P.', handle: '@dimitrap_ai', color: '#5478FF', quote: 'It is a real science showcase. It’s incredible to see how many researchers and engineers are joining in. Highly recommended! #GCAI2026' },
    { initials: 'DM', name: 'Darwin Mador', handle: '@darwin_m', color: '#5478FF', quote: 'Attending GCAI was the best decision! It’s practically ACCREDITED and keeps the research community focused on future-proofed solutions.' },
  ];
  ...
  const labelBase = { fontSize: '0.7rem', fontWeight: 700, textTransform: 'uppercase', color: 'rgba(27, 39, 81,0.45)', letterSpacing: '1.2px' };
  const fieldCol = { display: 'flex', flexDirection: 'column', gap: '0.55rem' };

  return (
    <div style={{ background: 'var(--bg-primary)', color: '#1b2751', minHeight: '100vh', fontFamily: 'var(--font-body)', position: 'relative', overflowX: 'clip' }}>

      <style>{`
        .gcai-root {
          --gc-display: var(--font-display);
          --gc-body: var(--font-body);
          --accent: #5478FF;
          --gc-ink: #1b2751;
        ...
        .gcai-root h1, .gcai-root h2, .gcai-root h3, .gcai-root h4 { color: #1b2751; }
        ...
        .gcai-grid-bg {
          background-image:
            linear-gradient(rgba(27, 39, 81, 0.045) 1px, transparent 1px),
            linear-gradient(90deg, rgba(27, 39, 81, 0.045) 1px, transparent 1px);
        ...
        .conf-banner-bar {
          background: #F5F7FA;
          border-bottom: 1px solid rgba(27, 39, 81, 0.08);
          padding: 0.5rem 1.5rem;
          text-align: center;
          font-size: 0.7rem;
          font-weight: 500;
          letter-spacing: 0.6px;
          color: rgba(27, 39, 81, 0.85);
          position: fixed;
        ...
        .conf-header.is-scrolled {
          ...
          border-bottom-color: rgba(27, 39, 81, 0.08);
        }
        ...
        .conf-nav-link:hover, .conf-nav-link.active { color: #1b2751; }
        ...
        .conf-btn-gold {
          ...
          text-decoration: none;
          box-shadow: 0 0 30px rgba(255, 222, 66, 0.25);
        ...
        .conf-btn-gold:hover { transform: translateY(-3px); box-shadow: 0 0 30px rgba(255, 222, 66, 0.4); }
        ...
        .conf-btn-ghost {
          ...
          border: 1px solid rgba(27, 39, 81, 0.15);
          color: #1b2751;
          font-weight: 700;
          font-family: var(--gc-display);
          font-size: 0.9rem;
        ...
        .section-kicker {
          ...
          border-radius: 100px;
          background: rgba(84, 120, 255, 0.06);
          margin-bottom: 1.4rem;
        }
        .section-kicker-dot {
          width: 6px; height: 6px; border-radius: 50%;
          background: #FFDE42;
          box-shadow: 0 0 8px rgba(255, 222, 66, 0.9);
        }
        ...
        .section-ghost {
          ...
          white-space: nowrap;
          color: transparent;
          -webkit-text-stroke: 1px rgba(27, 39, 81, 0.07);
          pointer-events: none;
          user-select: none;
          z-index: 0;
        }
        ...
        .flip-digit-window {
          ...
          justify-content: center;
          position: relative;
          box-shadow: inset 0 1px 0 rgb(255 255 255 / 0.9), 0 12px 26px rgba(27, 39, 81, 0.08);
        }
        ...
        .marquee-logo {
          ...
          font-weight: 500;
          letter-spacing: -0.5px;
          color: rgba(27, 39, 81, 0.38);
          white-space: nowrap;
          transition: color 0.3s, text-shadow 0.3s;
        }
        .marquee-logo:hover { color: #1b2751; }

        /* ------------------------------------------------ CARDS */
        .bento-card {
          background: #FFFFFF;
          border: 1px solid rgba(27, 39, 81, 0.09);
          border-radius: 16px;
          box-shadow: 0 2px 10px rgba(27, 39, 81, 0.04);
          transition: border-color 0.4s, box-shadow 0.4s, transform 0.4s cubic-bezier(0.16, 1, 0.3, 1);
        }
        .bento-card:hover {
          border-color: #FFDE42;
          box-shadow: 0 20px 50px rgba(27, 39, 81, 0.08);
          transform: translateY(-4px);
        }

        .conic-frame { position: relative; border-radius: 16px; }
        .conic-frame::before {
          content: '';
          position: absolute;
          inset: -1px;
          ...
          background: conic-gradient(from var(--angle, 0deg),
            transparent 0deg, rgba(84, 120, 255, 0.9) 40deg, transparent 90deg,
            transparent 180deg, rgba(84, 120, 255, 0.9) 220deg, transparent 270deg);
        ...
        .avatar-ring {
          ...
          border-radius: 50%;
          padding: 3px;
          background: conic-gradient(from 0deg, var(--ring-a, #5478FF), transparent 30%, var(--ring-a, #5478FF) 55%, transparent 80%, var(--ring-a, #5478FF));
        }
        ...
        .talk-row:hover {
          background: #FFFFFF;
          border-color: rgba(27, 39, 81, 0.09);
          box-shadow: 0 14px 34px rgba(27, 39, 81, 0.08);
        ...
        .talk-index {
          ...
          font-weight: 500;
          color: transparent;
          -webkit-text-stroke: 1px rgba(27, 39, 81, 0.25);
          line-height: 1;
          transition: all 0.4s;
          flex-shrink: 0;
          width: 70px;
        ...
        .ticket-divider {
          position: relative;
          border-top: 2px dashed rgba(27, 39, 81, 0.14);
        ...
        .ticket-tag {
          ...
          border-radius: 100px;
          border: 1px solid rgba(27, 39, 81, 0.16);
          color: rgba(27, 39, 81, 0.6);
        ...
        .ticket-tag.hot {
          ...
          color: #1b2751;
          background: #FFDE42;
          box-shadow: 0 0 18px rgba(255, 222, 66, 0.35);
        }
        .ticket-price {
          font-family: var(--gc-display);
          font-size: 2.6rem;
        ...
        .glass-input {
          ...
          border: 1px solid rgba(27, 39, 81, 0.14) !important;
          border-radius: 14px !important;
          color: #1b2751 !important;
        ...
        .glass-input:focus {
          ...
          box-shadow: 0 0 0 3px rgba(84, 120, 255, 0.14) !important;
        }
        .glass-input::placeholder { color: rgba(27, 39, 81, 0.32); }
        ...
        .sponsor-table th, .sponsor-table td {
          border-bottom: 1px solid rgba(27, 39, 81, 0.09);
          padding: 1.05rem 1.2rem;
          text-align: left;
        }
        .sponsor-table th {
          font-family: var(--gc-display);
          background: rgba(27, 39, 81, 0.03);
          font-weight: 500;
          text-transform: uppercase;
          letter-spacing: 1px;
          font-size: 0.75rem;
        ...
        .sponsor-table tbody tr:hover { background: rgba(84, 120, 255, 0.04); }
        ...
        .faq-item {
          ...
          border-radius: 18px;
          background: #FFFFFF;
          box-shadow: 0 2px 8px rgba(27, 39, 81, 0.03);
          transition: border-color 0.35s, background 0.35s;
          overflow: hidden;
        }
        .faq-item.open { border-color: #FFDE42; background: rgba(255, 222, 66, 0.05); }
        .faq-item:hover { border-color: rgba(27, 39, 81, 0.22); }
      ...
      <div className="gcai-root">
          ...
          <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '1.1rem 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <button
                ...
                onMouseEnter={handleHover}
                style={{
                  background: 'rgba(27, 39, 81,0.06)', border: '1px solid rgba(27, 39, 81,0.1)',
                  borderRadius: '12px', padding: '0.65rem', color: '#1b2751',
          ...
          {mobileMenuOpen && (
            <>
              <motion.div
                ...
                style={{ position: 'fixed', inset: 0, background: 'rgba(27, 39, 81, 0.35)', zIndex: 9998 }}
              />
              <motion.div
                ...
                style={{
                  ...
                  background: '#FFFFFF',
                  borderLeft: '1px solid rgba(27, 39, 81, 0.08)', zIndex: 9999,
                  padding: '2rem 1.8rem', display: 'flex', flexDirection: 'column', gap: '1.5rem'
                }}
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                  <span style={{ fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', color: 'var(--accent)', letterSpacing: '3px', fontFamily: "var(--gc-display)" }}>Menu</span>
                  <button onClick={() => { handleClick(); setMobileMenuOpen(false); }} style={{ background: 'none', border: 'none', color: '#1b2751', cursor: 'none' }}>
                    <X size={20} />
                  </button>
                </div>
                {navItems.map((item, i) => (
                  <motion.button
                    ...
                    style={{
                      ...
                      color: activeTab === item.id ? 'var(--accent)' : 'rgba(27, 39, 81,0.75)',
                      fontSize: '1.4rem', fontWeight: 700, fontFamily: "var(--gc-display)",
                      textTransform: 'uppercase', letterSpacing: '0.5px', padding: '0.5rem 0',
                      borderBottom: '1px solid rgba(27, 39, 81,0.06)'
                    }}
                  >
                    {item.label}
                  </motion.button>
          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <section className="gcai-grid-bg" style={{ position: 'relative', minHeight: 'calc(100vh - 108px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4rem 1.5rem 5rem', textAlign: 'center', overflow: 'hidden' }}>
                  <div style={{ maxWidth: '1050px', margin: '0 auto', position: 'relative', zIndex: 5 }}>
                    ...
                    <h2 className="serif-font" style={{ fontSize: 'clamp(1.6rem, 3.6vw, 2.8rem)', fontWeight: 400, color: 'rgba(27, 39, 81, 0.9)', margin: '0 0 0.8rem 0', letterSpacing: '0.5px' }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '0.8rem', margin: '2.4rem 0 0' }}>
                      ...
                      <span className="hero-meta-chip"><Calendar size={13} style={{ color: '#5478FF' }} /> September 14 – 16, 2026</span>
                      <span className="hero-meta-chip"><Globe size={13} style={{ color: '#5478FF' }} /> Hybrid • Live + Virtual</span>
                    </div>
                ...
                {/* TRUSTED BY MARQUEE */}
                <section style={{ borderTop: '1px solid rgba(27, 39, 81,0.06)', borderBottom: '1px solid rgba(27, 39, 81,0.06)', padding: '2.6rem 0', background: 'var(--bg-tertiary)' }}>
                  <div style={{ textAlign: 'center', fontSize: '0.68rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '4px', color: 'rgba(27, 39, 81,0.35)', marginBottom: '1.8rem', fontFamily: "var(--gc-display)" }}>
                ...
                {/* STATS BAND */}
                <section style={{ padding: '5rem 1.5rem', borderBottom: '1px solid rgba(27, 39, 81,0.06)' }}>
                  <div className="stats-band" style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2rem', textAlign: 'center' }}>
                    {[
                      ...
                      { end: 40, suffix: '+', label: 'Countries Represented', color: '#5478FF' },
                      { end: 60, suffix: '+', label: 'Live Talks & Panels', color: '#5478FF' },
                      { end: 8, suffix: '', label: 'Scientific Tracks', color: '#5478FF' },
                    ].map((s, i) => (
                      <Reveal key={s.label} delay={i * 0.1}>
                        <div className="gcai-display" style={{ fontSize: 'clamp(2.4rem, 5vw, 3.6rem)', fontWeight: 700, color: s.color, textShadow: `0 0 32px ${s.color}44`, lineHeight: 1 }}>
                          <CountUp end={s.end} suffix={s.suffix} />
                        </div>
                        <div style={{ marginTop: '0.7rem', fontSize: '0.72rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '2.5px', color: 'rgba(27, 39, 81,0.45)', fontFamily: "var(--gc-display)" }}>
                          {s.label}
                        </div>
                      </Reveal>
                    ))}
                ...
                {/* OFFICIAL THEME */}
                <section style={{ padding: '5.5rem 1.5rem', borderBottom: '1px solid rgba(27, 39, 81,0.06)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                  ...
                  <Reveal style={{ maxWidth: '980px', margin: '0 auto', position: 'relative' }}>
                    ...
                    <h3 className="serif-font" style={{ fontSize: 'clamp(1.35rem, 3.6vw, 2.2rem)', color: '#1b2751', margin: '0.5rem 0 0', lineHeight: 1.5, fontWeight: 400 }}>
                      “Advancing Deep Learning Architectures: Shaping the Future of{' '}
                      <span style={{ color: 'var(--accent)', textShadow: '0 0 26px rgba(84, 120, 255,0.35)' }}>Global Biotech</span> &{' '}
                      <span style={{ color: '#5478FF', textShadow: '0 0 26px rgba(84, 120, 255,0.35)' }}>Precision Agriculture</span>”
                    </h3>
                  </Reveal>
                </section>

                {/* KEYNOTE SPEAKERS */}
                <section className="section" style={{ borderBottom: '1px solid rgba(27, 39, 81,0.06)' }}>
                      ...
                      {speakers.map((sp, i) => (
                        <Reveal key={sp.initials} delay={i * 0.1}>
                          <TiltCard className="bento-card" style={{ padding: '2.4rem 2rem', textAlign: 'center', height: '100%' }}>
                            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.6rem' }}>
                              <div className="avatar-ring" style={{ '--ring-a': sp.color }}>
                                <div style={{
                                  ...
                                  fontSize: '1.7rem', fontWeight: 700, fontFamily: "var(--gc-display)",
                                  color: '#FFF',
                            ...
                            <h3 className="gcai-display" style={{ fontSize: '1.2rem', fontWeight: 700, marginBottom: '0.35rem' }}>{sp.name}</h3>
                            <span style={{ fontSize: '0.72rem', color: sp.color, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '1rem', display: 'block', fontFamily: "var(--gc-display)" }}>{sp.org}</span>
                            <p style={{ fontSize: '0.85rem', color: 'rgba(27, 39, 81,0.55)', lineHeight: 1.6, margin: 0 }}>{sp.bio}</p>
                          </TiltCard>
                        </Reveal>
                      ))}
                    </div>
                ...
                <section className="section" style={{ borderBottom: '1px solid rgba(27, 39, 81,0.06)', background: 'var(--bg-tertiary)' }}>
                  <div style={{ maxWidth: '1240px', margin: '0 auto', padding: '0 1.5rem' }}>
                    <SectionHeading kicker="Why Register?" title="Conference Benefits" ghost="Benefits" />
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.8rem' }}>
                      {[
                        { Icon: Award, color: '84, 120, 255', accent: 'var(--accent)', title: 'Official CPD Accreditation', desc: 'Obtain official Continuing Professional Development certification hours. A structured transcript is sent to all registered academic delegates.' },
                        { Icon: BookOpen, color: '84, 120, 255', accent: '#5478FF', title: 'Indexed Abstract Booklet', desc: 'All accepted peer-reviewed abstract entries are fully published and cataloged in the GCAI 2026 Proceedings Handbook.' },
                        { Icon: User, color: '84, 120, 255', accent: '#5478FF', title: 'Virtual Networking Lounges', desc: 'Connect with global peers inside custom Zoom breakout channels and digital roundtable sessions. Engage directly with presenters.' },
                        { Icon: Shield, color: '84, 120, 255', accent: '#5478FF', title: 'Permanent Recordings Access', desc: 'Never miss a parallel session. Obtain lifetime access to high-definition video recordings of all keynote lectures and panel studies.' },
                      ].map((b, i) => (
                        <Reveal key={b.title} delay={i * 0.08}>
                          <SpotlightCard className="bento-card" color={b.color} style={{ padding: '2.5rem', height: '100%', borderRadius: '16px' }}>
                            <div style={{
                            ...
                            <h3 className="gcai-display" style={{ fontSize: '1.2rem', fontWeight: 700, marginBottom: '0.8rem' }}>{b.title}</h3>
                            <p style={{ fontSize: '0.87rem', color: 'rgba(27, 39, 81,0.55)', lineHeight: 1.6, margin: 0 }}>{b.desc}</p>
                          </SpotlightCard>
                        </Reveal>
                      ))}
                    </div>
                ...
                {/* PASS CALLOUT */}
                <section id="tickets-section" className="section" style={{ borderBottom: '1px solid rgba(27, 39, 81,0.06)' }}>
                    ...
                    <Reveal>
                      <div className="conic-frame">
                        <div className="bento-card" style={{ padding: 'clamp(2.5rem, 6vw, 4.5rem) clamp(1.5rem, 5vw, 3.5rem)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                          <div aria-hidden="true" style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 70% 100% at 50% 0%, rgba(84, 120, 255,0.06), transparent 60%)' }} />
                          <span className="section-kicker" style={{ position: 'relative' }}><span className="section-kicker-dot" />Secure Your Attendance</span>
                          <h3 className="gcai-display" style={{ fontSize: 'clamp(1.7rem, 4vw, 2.4rem)', fontWeight: 700, margin: '0.4rem 0 1.2rem', position: 'relative', letterSpacing: '-0.02em' }}>Choose Your Conference Pass</h3>
                          <p style={{ fontSize: '1rem', color: 'rgba(27, 39, 81,0.6)', lineHeight: 1.65, maxWidth: '720px', margin: '0 auto 2.5rem', position: 'relative' }}>
                          ...
                          <div className="talk-row" style={{ '--talk-c': talk.color }}>
                            ...
                            <div style={{ flex: 1 }}>
                              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.8rem', alignItems: 'center', marginBottom: '0.6rem' }}>
                                <span style={{ fontSize: '0.68rem', color: talk.color, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', background: 'rgba(27, 39, 81,0.03)', padding: '0.25rem 0.6rem', borderRadius: '100px', border: '1px solid rgba(27, 39, 81,0.07)', fontFamily: "var(--gc-display)" }}>{talk.duration}</span>
                                <span style={{ fontSize: '0.72rem', color: 'rgba(27, 39, 81,0.4)', fontWeight: 600, fontFamily: "var(--gc-display)" }}>{talk.time} • {talk.room}</span>
                              </div>
                              <h4 className="gcai-display" style={{ fontSize: '1.2rem', fontWeight: 700, margin: '0 0 0.45rem', lineHeight: 1.35 }}>{talk.title}</h4>
                              <span style={{ fontSize: '0.85rem', color: 'rgba(27, 39, 81, 0.45)' }}>By <strong style={{ color: '#1b2751' }}>{talk.speakers}</strong> — {talk.affiliation}</span>
                            </div>
                            <div className="avatar-ring" style={{ '--ring-a': talk.color, flexShrink: 0 }}>
                              <div style={{ width: '54px', height: '54px', borderRadius: '50%', background: '#F1F3F8', border: '3px solid #FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center', color: talk.color, fontWeight: 700, fontSize: '1rem', fontFamily: "var(--gc-display)", position: 'relative', overflow: 'hidden' }}>
                                {talk.initials}
                  ...
                  <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 1.5rem' }}>
                    <Reveal>
                      <div className="bento-card" style={{ padding: 'clamp(2.5rem, 6vw, 4rem) clamp(1.5rem, 5vw, 3rem)', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                        <div aria-hidden="true" style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 60% 100% at 50% 100%, rgba(84, 120, 255,0.07), transparent 60%)' }} />
                        <span className="section-kicker" style={{ position: 'relative', borderColor: 'rgba(84, 120, 255,0.3)', color: '#5478FF', background: 'rgba(84, 120, 255,0.05)' }}>
                          <span className="section-kicker-dot" style={{ background: '#5478FF', boxShadow: '0 0 8px #5478FF' }} />
                          Deadline: August 10, 2026
                        </span>
                        <h3 className="gcai-display" style={{ fontSize: 'clamp(1.6rem, 4vw, 2.2rem)', fontWeight: 700, margin: '0.4rem 0 1.2rem', position: 'relative', letterSpacing: '-0.02em' }}>Call For Papers & Abstracts</h3>
                        <p style={{ fontSize: '1rem', color: 'rgba(27, 39, 81,0.65)', lineHeight: 1.65, maxWidth: '760px', margin: '0 auto 2.5rem', position: 'relative' }}>
                ...
                <section className="section" style={{ borderBottom: '1px solid rgba(27, 39, 81,0.06)', background: 'var(--bg-tertiary)' }}>
                  <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 1.5rem', textAlign: 'center' }}>
                    ...
                    <Reveal>
                      <p className="serif-font" style={{ fontSize: 'clamp(1.15rem, 2.6vw, 1.5rem)', color: 'rgba(27, 39, 81, 0.88)', lineHeight: 1.7, maxWidth: '840px', margin: '0 auto 1.5rem' }}>
                      ...
                      <p style={{ fontSize: '0.95rem', color: 'rgba(27, 39, 81, 0.4)', margin: 0 }}>This event is organized by the research community, for the community.</p>
                    </Reveal>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.6rem' }}>
                      {committee.map((m, i) => (
                        <Reveal key={m.initials} delay={i * 0.08}>
                          <SpotlightCard className="bento-card" style={{ padding: '1.6rem', borderRadius: '16px' }}>
                            <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                              <div style={{ width: '46px', height: '46px', borderRadius: '14px', background: m.color, color: '#FFF', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: '0.9rem', flexShrink: 0, fontFamily: "var(--gc-display)", boxShadow: `0 0 16px ${m.color}44` }}>{m.initials}</div>
                              <div>
                                <h4 className="gcai-display" style={{ fontSize: '0.98rem', fontWeight: 700, margin: 0 }}>{m.name}</h4>
                                <span style={{ fontSize: '0.76rem', color: 'rgba(27, 39, 81,0.45)' }}>{m.org}</span>
                              </div>
                            </div>
                          </SpotlightCard>
                        </Reveal>
                ...
                {/* MAIN SPONSORS */}
                <section style={{ padding: '5rem 1.5rem', borderBottom: '1px solid rgba(27, 39, 81,0.06)', background: 'var(--bg-tertiary)', textAlign: 'center' }}>
                  <Reveal>
                    <h2 style={{ fontSize: '0.75rem', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '5px', color: 'var(--accent)', marginBottom: '3rem', fontFamily: "var(--gc-display)" }}>Main Sponsors</h2>
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: 'clamp(2.5rem, 8vw, 6rem)' }}>
                      {[
                        { name: 'Tokens Studio', color: '#1b2751' },
                        { name: 'Specify', color: '#5478FF' },
                        { name: 'i-Cultiver', color: '#5478FF' },
                      ].map((s) => (
                        <Magnetic key={s.name} strength={0.2}>
                          <span className="gcai-display" style={{ fontSize: 'clamp(1.5rem, 4vw, 2.1rem)', fontWeight: 700, letterSpacing: '-0.5px', color: s.color, opacity: 0.85, textShadow: `0 0 30px ${s.color}33`, cursor: 'none' }}>{s.name}</span>
                        </Magnetic>
                      ))}
                    </div>
                  </Reveal>
                      ...
                      {testimonials.map((t, i) => (
                        <Reveal key={t.initials} delay={i * 0.1}>
                          <TiltCard max={6} className="bento-card" style={{ padding: '2rem', height: '100%' }}>
                            ...
                            <p style={{ margin: '0 0 1.6rem', fontSize: '0.9rem', lineHeight: 1.65, color: 'rgba(27, 39, 81,0.72)' }}>{t.quote}</p>
                            <div style={{ display: 'flex', gap: '0.8rem', alignItems: 'center' }}>
                              <div style={{ width: '42px', height: '42px', borderRadius: '50%', background: t.color, display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 700, fontSize: '0.9rem', color: '#FFF', fontFamily: "var(--gc-display)", boxShadow: `0 0 20px ${t.color}44` }}>{t.initials}</div>
                              <div>
                                <h4 className="gcai-display" style={{ fontSize: '0.9rem', fontWeight: 700, margin: 0 }}>{t.name}</h4>
                                <span style={{ fontSize: '0.75rem', color: 'rgba(27, 39, 81,0.4)' }}>{t.handle}</span>
                              </div>
                            </div>
                          </TiltCard>
                        </Reveal>
                      ...
                      {faqs.map((item, idx) => (
                        <Reveal key={idx} delay={idx * 0.06}>
                          <div className={`faq-item ${faqOpenIndex === idx ? 'open' : ''}`}>
                            ...
                            >
                              <span className="gcai-display" style={{ fontSize: '1.02rem', fontWeight: 700, color: '#1b2751' }}>{item.q}</span>
                              <motion.span
                            ...
                            <AnimatePresence>
                              {faqOpenIndex === idx && (
                                ...
                                >
                                  <p style={{ fontSize: '0.9rem', color: 'rgba(27, 39, 81,0.62)', lineHeight: 1.65, margin: 0, padding: '0 1.8rem 1.6rem' }}>
                                    {item.a}
                                  </p>
                                </motion.div>
                              )}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.8rem' }}>
                  {sessions.map((sess, idx) => (
                    <Reveal key={sess.id} delay={(idx % 3) * 0.08}>
                      <SpotlightCard className="bento-card" style={{ padding: '2.2rem', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '280px', borderRadius: '16px', height: '100%' }}>
                        <div>
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.4rem' }}>
                            <span className="gcai-display" style={{ fontSize: '2.2rem', fontWeight: 700, color: 'transparent', WebkitTextStroke: '1px rgba(84, 120, 255,0.4)', lineHeight: 1 }}>
                              {String(idx + 1).padStart(2, '0')}
                            </span>
                            <span style={{ display: 'inline-flex', background: 'rgba(84, 120, 255,0.06)', border: '1px solid rgba(84, 120, 255,0.3)', color: 'var(--accent)', padding: '0.3rem 0.75rem', borderRadius: '100px', fontSize: '0.62rem', fontWeight: 700, letterSpacing: '1.5px', fontFamily: "var(--gc-display)" }}>
                              TRACK
                            </span>
                          </div>
                          <h3 className="gcai-display" style={{ fontSize: '1.22rem', fontWeight: 700, marginBottom: '0.8rem', lineHeight: 1.3 }}>{sess.title}</h3>
                          <p style={{ fontSize: '0.87rem', color: 'rgba(27, 39, 81,0.55)', lineHeight: 1.6 }}>{sess.desc}</p>
                        </div>
                        <div style={{ marginTop: '1.6rem', borderTop: '1px solid rgba(27, 39, 81,0.06)', paddingTop: '1.2rem' }}>
                          <button
                            onClick={() => {
                              handleClick();
                            ...
                            onMouseEnter={handleHover}
                            style={{ background: 'none', border: 'none', color: '#5478FF', fontSize: '0.8rem', fontWeight: 700, display: 'inline-flex', alignItems: 'center', gap: '0.45rem', cursor: 'none', fontFamily: "var(--gc-display)", letterSpacing: '0.5px' }}
                          >
              ...
              >
                ...
                <Reveal>
                  <div className="bento-card" style={{ padding: '2.5rem', marginBottom: '2.5rem' }}>
                    <h3 className="gcai-display" style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '1.4rem' }}>Submission Instructions</h3>
                    <ul style={{ paddingLeft: 0, listStyle: 'none', fontSize: '0.9rem', color: 'rgba(27, 39, 81,0.72)', display: 'flex', flexDirection: 'column', gap: '0.9rem', lineHeight: 1.6, margin: 0 }}>
                      {[
                ...
                <Reveal delay={0.1}>
                  <div className="conic-frame">
                    <div className="bento-card" style={{ padding: 'clamp(2rem, 5vw, 3rem) clamp(1.5rem, 4vw, 2.5rem)' }}>
                      <h3 className="gcai-display" style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '1.8rem' }}>Submit Your Abstract Summary</h3>

                      {abstractSubmitted ? (
                        <div style={{ textAlign: 'center', padding: '2.5rem 0' }}>
                          <SuccessCheck />
                          <h4 className="gcai-display" style={{ fontSize: '1.25rem', fontWeight: 700, margin: '1.4rem 0 0' }}>Abstract Filed Successfully</h4>
                          <p style={{ fontSize: '0.88rem', color: 'rgba(27, 39, 81,0.5)', marginTop: '0.6rem' }}>
                          ...
                          <div style={{ display: 'grid', gridTemplateColumns: '1.8fr 1fr', gap: '1.5rem' }} className="responsive-grid-2">
                            ...
                            <div style={fieldCol}>
                              ...
                              <select value={abstractForm.session}
                                ...
                                {sessions.map((sess) => (
                                  <option key={sess.id} value={sess.id} style={{ background: '#FFFFFF', color: '#1b2751' }}>
                                    {sess.title}
                                  </option>
                                ))}
                              </select>
              ...
              >
                ...
                <Reveal>
                  <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '2.5rem', marginBottom: '3.5rem', alignItems: 'center' }} className="responsive-grid-2">
                    <div>
                      <h3 className="gcai-display" style={{ fontSize: '1.6rem', fontWeight: 700, marginBottom: '1rem' }}>NH Roma Villa Carpegna</h3>
                      <p style={{ fontSize: '0.95rem', color: 'rgba(27, 39, 81,0.68)', lineHeight: 1.7, marginBottom: '1.6rem' }}>
                    ...
                    <TiltCard max={7} style={{ borderRadius: '16px' }}>
                      <div style={{ aspectRatio: '16/11', borderRadius: '16px', background: 'linear-gradient(150deg, #0a1128 0%, #131c3d 100%)', border: '1px solid rgba(27, 39, 81,0.07)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 24px 50px rgba(0,0,0,0.4)', position: 'relative', overflow: 'hidden' }}>
                ...
                <div className="responsive-grid-3" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.8rem', marginBottom: '3.5rem' }}>
                  {[
                    { Icon: Plane, title: 'By Air', color: '84, 120, 255', text: 'Participants can fly into Leonardo da Vinci–Fiumicino Airport (FCO) (30km from hotel) or Ciampino Airport (CIA). Taxi, train, and shuttle systems link the terminals directly to the hotel district.' },
                    { Icon: TrainFront, title: 'By Train', color: '84, 120, 255', text: 'Arrive at Roma Termini central station. From there, take the Metro Line A to Cornelia station, which is a short taxi ride or walk from the NH Roma Villa Carpegna.' },
                    { Icon: Bus, title: 'Local Transit', color: '84, 120, 255', text: "Rome has a comprehensive subway (Metro), streetcar, and bus system. Bus lines connect the hotel area directly to St. Peter's Square and the Vatican City center." },
                  ].map((t, i) => (
                    <Reveal key={t.title} delay={i * 0.08}>
                      <SpotlightCard className="bento-card" color={t.color} style={{ padding: '2rem', borderRadius: '16px', height: '100%' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', marginBottom: '1rem' }}>
                          ...
                          <h4 className="gcai-display" style={{ fontSize: '1.1rem', fontWeight: 700, margin: 0 }}>{t.title}</h4>
                        </div>
                        <p style={{ fontSize: '0.85rem', color: 'rgba(27, 39, 81,0.6)', lineHeight: 1.6, margin: 0 }}>{t.text}</p>
                      </SpotlightCard>
                    </Reveal>
                  ))}
                </div>
                ...
                <Reveal>
                  <div className="bento-card" style={{ padding: 'clamp(2rem, 5vw, 3rem) clamp(1.5rem, 4vw, 2.5rem)' }}>
                    <h3 className="gcai-display" style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '0.5rem' }}>Visa Support Invitation Letter</h3>
                    <p style={{ fontSize: '0.85rem', color: 'rgba(27, 39, 81,0.45)', marginBottom: '2rem' }}>
                    ...
                    {visaSubmitted ? (
                      <div style={{ textAlign: 'center', padding: '2rem 0' }}>
                        ...
                        <h4 className="gcai-display" style={{ fontSize: '1.15rem', fontWeight: 700, margin: '1.2rem 0 0' }}>Request Filed!</h4>
                        <p style={{ fontSize: '0.82rem', color: 'rgba(27, 39, 81,0.5)', marginTop: '0.5rem' }}>
            ...
            {activeTab === 'sponsors' && (
              ...
              >
                ...
                <Reveal>
                  <div className="bento-card" style={{ padding: '2.5rem', marginBottom: '2.5rem' }}>
                    <h3 className="gcai-display" style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '1.2rem' }}>Why Sponsor GCAI 2026?</h3>
                    <p style={{ fontSize: '0.95rem', color: 'rgba(27, 39, 81,0.68)', lineHeight: 1.7, margin: 0 }}>
                ...
                <Reveal delay={0.08}>
                  <div className="bento-card" style={{ padding: '2.5rem', marginBottom: '2.5rem', overflowX: 'auto' }}>
                    <h3 className="gcai-display" style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '0.4rem' }}>Sponsorship Tier Comparison</h3>
                    <table className="sponsor-table">
                      <thead>
                        <tr>
                          <th>Benefits / Features</th>
                          <th style={{ color: 'var(--accent)' }}>Gold ($5,000)</th>
                          <th style={{ color: '#5478FF' }}>Silver ($3,000)</th>
                          <th style={{ color: '#5478FF' }}>Exhibitor ($1,500)</th>
                        </tr>
                      </thead>
                      <tbody>
                        {[
                ...
                <Reveal delay={0.12}>
                  <div className="conic-frame">
                    <div className="bento-card" style={{ padding: 'clamp(2rem, 5vw, 3rem) clamp(1.5rem, 4vw, 2.5rem)' }}>
                      <h3 className="gcai-display" style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '0.5rem' }}>Apply to Sponsor / Exhibit</h3>
                      <p style={{ fontSize: '0.85rem', color: 'rgba(27, 39, 81,0.45)', marginBottom: '2rem' }}>
                      ...
                      {sponsorSubmitted ? (
                        <div style={{ textAlign: 'center', padding: '2rem 0' }}>
                          <SuccessCheck size={60} />
                          <h4 className="gcai-display" style={{ fontSize: '1.15rem', fontWeight: 700, margin: '1.2rem 0 0' }}>Application Filed!</h4>
                          <p style={{ fontSize: '0.82rem', color: 'rgba(27, 39, 81,0.5)', marginTop: '0.5rem' }}>
                          ...
                          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1.2fr', gap: '1.5rem' }} className="responsive-grid-2">
                            ...
                            <div style={fieldCol}>
                              ...
                              <select value={sponsorForm.tier}
                                ...
                                <option value="Gold Sponsor" style={{ background: '#FFFFFF', color: '#1b2751' }}>Gold Sponsor ($5,000)</option>
                                <option value="Silver Sponsor" style={{ background: '#FFFFFF', color: '#1b2751' }}>Silver Sponsor ($3,000)</option>
                                <option value="Bronze Sponsor" style={{ background: '#FFFFFF', color: '#1b2751' }}>Bronze Sponsor ($1,500)</option>
                                <option value="Exhibitor Booth" style={{ background: '#FFFFFF', color: '#1b2751' }}>Exhibitor Booth ($1,000)</option>
                              </select>
                            </div>
                          </div>
              ...
              >
                ...
                <Reveal>
                  <div className="bento-card" style={{ padding: '2.5rem', marginBottom: '3rem' }}>
                    <h3 className="gcai-display" style={{ fontSize: '1.3rem', fontWeight: 700, marginBottom: '1.2rem' }}>Registration Packages</h3>
                    <p style={{ fontSize: '0.95rem', color: 'rgba(27, 39, 81,0.68)', lineHeight: 1.7, marginBottom: '1.6rem' }}>
                      ...
                      <div className={p.highlight ? 'conic-frame' : ''} style={{ height: '100%' }}>
                        <div className="ticket-pass" style={{ height: '100%' }}>
                          <div>
                            ...
                            <h3 className="gcai-display" style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '0.6rem' }}>{p.type}</h3>
                            <p style={{ fontSize: '0.85rem', color: 'rgba(27, 39, 81,0.55)', lineHeight: 1.55, margin: 0 }}>{p.desc}</p>
                          </div>
                          <div>
                            <div className="ticket-divider" />
                            <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.4rem', marginBottom: '1.2rem' }}>
                              <span className="ticket-price" style={{ color: p.highlight ? '#1b2751' : '#1b2751' }}>
                                ${p.price.toLocaleString()}
                              </span>
                              <span style={{ fontSize: '0.72rem', color: 'rgba(27, 39, 81,0.35)', fontFamily: "var(--gc-display)", textTransform: 'uppercase', letterSpacing: '1px' }}>/ pass</span>
                            </div>
        ...
        <AnimatePresence>
          {ticketModalOpen && (
            <motion.div
              initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
              style={{
                position: 'fixed', inset: 0, background: 'rgba(27, 39, 81, 0.35)',
            ...
            >
              ...
              >
                <div style={{
                  ...
                  background: '#FFFFFF',
                  border: '1px solid rgba(27, 39, 81, 0.1)',
                  boxShadow: '0 40px 90px rgba(27, 39, 81, 0.25)',
                  position: 'relative',
                }}>
                  <button
                    ...
                    style={{
                      ...
                      background: 'rgba(27, 39, 81,0.05)', border: '1px solid rgba(27, 39, 81,0.1)',
                      borderRadius: '10px', padding: '0.5rem',
                      color: 'rgba(27, 39, 81,0.5)', cursor: 'none',
                      display: 'flex', transition: 'color 0.2s'
                    }}
                    onMouseEnter={(e) => { e.currentTarget.style.color = '#1b2751'; handleHover(); }}
                    onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(27, 39, 81,0.5)'}
                  >
                    <X size={18} />
                  </button>

                  <h3 className="gcai-display" style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '0.5rem' }}>
                    Register Delegate Pass
                  </h3>
                  <p style={{ fontSize: '0.85rem', color: 'rgba(27, 39, 81,0.45)', marginBottom: '2.2rem' }}>
                  ...
                  {ticketSubmitted ? (
                    <div style={{ textAlign: 'center', padding: '2.5rem 0' }}>
                      <SuccessCheck />
                      <h4 className="gcai-display" style={{ fontSize: '1.25rem', fontWeight: 700, margin: '1.4rem 0 0' }}>Registration Logged!</h4>
                      <p style={{ fontSize: '0.85rem', color: 'rgba(27, 39, 81,0.45)', marginTop: '0.5rem' }}>
        ...
        {/* FOOTER */}
        <footer style={{ borderTop: '1px solid rgba(27, 39, 81, 0.07)', padding: '3.5rem 1.5rem', position: 'relative', overflow: 'hidden' }}>
          <div aria-hidden="true" style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse 60% 120% at 50% 100%, rgba(84, 120, 255,0.045), transparent 60%)' }} />
          <div style={{ maxWidth: '1000px', margin: '0 auto', textAlign: 'center', position: 'relative' }}>
            ...
            <p style={{ fontSize: '0.8rem', color: 'rgba(27, 39, 81,0.4)', margin: '0 0 1.6rem', fontFamily: "var(--gc-display)", letterSpacing: '1px' }}>
              Budapest, Hungary • September 14 – 16, 2026
            </p>
            <span style={{ fontSize: '0.75rem', color: 'rgba(27, 39, 81,0.3)' }}>© {new Date().getFullYear()} GCAI CON 2026. All rights reserved.</span>
          </div>
        </footer>
